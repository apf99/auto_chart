...
cv2.imshow('Axes and Measures', result_image)
cv2.waitKey(0)
cv2.destroyAllWindows()
...
cv2.imshow('Contour Imag with End Points', contour_img)
cv2.waitKey(0)
cv2.destroyAllWindows()
...
cv2.imshow('First Pass Bitmap', bitmap)
cv2.waitKey(0)
cv2.destroyAllWindows()
...
cv2.imshow('Anomaly Marking', contour_img_updated)
cv2.waitKey(0)
cv2.destroyAllWindows()
...
cv2.imshow('Final Bitmap', bitmap)
cv2.waitKey(0)
cv2.destroyAllWindows()
